...
class InputLoader:
    ...
    def set_endpoints(self) -> None:
        ...
        # TODO: offload api calls to PantherWrapper
    ...
    def log_paging_progress(response: WorkspaceResponse) -> None:
        ...
        if current_page and total_pages:
            ...
            )  # TODO: use a singleton observer for logging
    ...
    def get_hierarchies(self, list_of_parent_workspaces: list[str]) -> list[str]:
        """Returns a list of all workspace IDs in the organization, including their hierarchies."""
        list_of_children: list[str] = []

        for parent in list_of_parent_workspaces:
            list_of_children.extend(self.get_hierarchy(parent))

        # Include the parent workspaces in the backup
        return list_of_parent_workspaces + list_of_children
